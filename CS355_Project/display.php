...
<div class="" style="background-color: #90E0EF; position: relative; left: 170px; top: 5px; width: 1200px; height: 950px;">
    ...
    <p style=""><span style="position: relative; left: 50px;">Institute ID : <input type="text" value="<?php echo $_SESSION['user_id'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span><span style="position: relative; left: 100px;">Indentor Name : <input type="text" value="<?php echo $_SESSION['name'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span><span style="position: relative; left: 150px;">Designation : <input type="text" value="<?php echo $_SESSION['designation'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span></p><br/>
    <p style=""><span style="position: relative; left: 50px;">Department : <input type="text" value="<?php echo $_SESSION['department'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span><span style="position: relative; left: 100px;">Phone : <input type="text" value="<?php echo $_SESSION['phone'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span><span style="position: relative; left: 150px;">Email : <input type="text" value="<?php echo $_SESSION['email'];?>" style="width: 175px; height: 25px; border-radius: 5px; border: 2px solid white; font-size: 16px;" readonly></span></p><br/><br/><br/>
    ...
    <br/><br/>
    <button type="button" class="register" style="position: relative; left: 485px;" onclick="window.location.href = 'booking.php'">
